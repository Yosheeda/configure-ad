...
<h1>Configuring Active Directory Within Azure(On-Premises)</h1>
...
<p>  
  Create a new File and paste the contents of this script (https://github.com/Yosheeda/configure-ad/blob/main/CreatingUser) into it:
</p>
<p>
